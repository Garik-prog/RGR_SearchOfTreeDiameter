...
### 1.1 Цель
    Найти наибольший эксцентриситет (диаметр) в заданном дереве 

### 1.2 Способы задания графов
-  Список рёбер из файла
-  Таблица смежности из файла
-  Случайная генерация дерева с помощью интерфейса программы 
...
что и позволяет найти наиболее удалённые друг от друга вершины.
После чего
...
и **tree_adjacency.txt** (матрица смежности), следуя шаблонам, представленным ниже
...
```
7     <-- число вершин
0 1   <-- ребро весом 1 между 0 и 1 вершиной дерева 
1 2   <-- и т.д.
1 3
2 4
3 5
...
4 0 3 2 0 0 0  \
0 3 0 0 7 0 0   \
0 2 0 0 0 5 0    | <-- таблица смежности дерева    
0 0 7 0 0 0 6   /
0 0 0 5 0 0 0  /
0 0 0 0 6 0 0 /
```
...
- Примеры результатов работы можно посмотреть 
в директории 
`examples`- она находится в корне проекта
